        ...
        <table class="table table-hover">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ $d->ket_stnk }}</td>
                    <td>
                        <a href="/data/mobil/update/{{$d->id}}" class="btn btn-success"><i class="bi bi-pencil-square"></i></a>
                        <a href="/data/mobil/delete/{{$d->id}}" class="btn btn-danger"><i class="bi bi-trash"></i></a>
                    </td>
                </tr>
                @endforeach
            </tbody>
